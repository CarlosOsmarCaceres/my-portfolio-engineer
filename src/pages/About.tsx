      ...
      <section className="container-wide py-16 md:py-24">
        <div className="max-w-3xl space-y-12">
          ...
          <div>
            ...
            >
              <p>
                <span className="text-foreground">Carlos Osmar Caceres</span> is
                an independent creative studio specializing in brand identity,
                illustration, and visual design.
              </p>
              <p>
                Our approach combines minimalist aesthetics, authentic
                storytelling, and thoughtful design. Each project is an
                opportunity to explore stories through a unique visual language.
              </p>
              <p>
